...
const struct{uint8_t bLength;uint8_t bDscType;uint16_t string[27];}sd002={
sizeof(sd002),USB_DESCRIPTOR_STRING,
'R','F','G','E','N','4','4',' ','R','F',' ','S','i','g','n','a','l',' ','G','e','n','e','r','a','t','o','r'};


//Product string descriptor
 struct{uint8_t bLength;uint8_t bDscType;uint16_t string[12];}sd003={
sizeof(sd003),USB_DESCRIPTOR_STRING, 
'R','F','G','E','N','4','4','U','N','P','R','G'};
...
{
    sd003.string [12 - 5] = nibble_to_hex( (deviceinfo.serialNumber >> 16) & 0xF ); 
    sd003.string [12 - 4] = nibble_to_hex( (deviceinfo.serialNumber >> 12) & 0xF ); 
    sd003.string [12 - 3] = nibble_to_hex( (deviceinfo.serialNumber >> 8) & 0xF ); 
    sd003.string [12 - 2] = nibble_to_hex( (deviceinfo.serialNumber >> 4) & 0xF ); 
    sd003.string [12 - 1] = nibble_to_hex( (deviceinfo.serialNumber) & 0xF );
