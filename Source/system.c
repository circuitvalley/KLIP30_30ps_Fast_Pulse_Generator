...
{ 
    switch(state)
    {
        case SYSTEM_STATE_USB_START:
            ...
            #endif
            flashReadBlock(FLASH_ADDR2,(uint8_t *)&deviceinfo);
            makeSerialNumber();
            ...
            setRF_LOCK_TRIS(TRIS_INPUT);
            setSDO_TRIS(TRIS_OUTPUT);
            setCLK_TRIS(TRIS_OUTPUT);
            setCE(1);
            
            setSTATUS_LED(0);
            setSTATUS_LED_ANSEL(ANSEL_DIGITAL);
            setSTATUS_LED_TRIS(TRIS_OUTPUT);
                    
            setEN_EXTREF_ANSEL(ANSEL_DIGITAL);
            
            setSYNC_IN_TRIS(TRIS_INPUT);
            setSYNC_IN_ANSEL(ANSEL_DIGITAL);
                    
            setEN_SYNC_OUT(DISABLE_BUFFER);
            setEN_SYNC_OUT_TRIS(TRIS_OUTPUT);
            setEN_SYNC_OUT_ANSEL(ANSEL_DIGITAL);
                    
            setEN_INTREF(ENABLE_BUFFER);
            setEN_EXTREF(DISABLE_BUFFER);
            setEN_INTREF_TRIS(TRIS_OUTPUT);
            setEN_EXTREF_TRIS(TRIS_OUTPUT);
            

            setSYNC_OUT_TRIS(TRIS_OUTPUT);
            
            adf4351AuxCtrl(AUX_SYNC_OUT);
            
            initTimer1();
            adf4351System.flashReadPending = true;
            break;
